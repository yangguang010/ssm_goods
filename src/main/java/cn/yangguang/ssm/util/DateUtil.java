...
public class DateUtil {
    ...
    /**
     * 时间格式：年-月-日 时:分      24小时制   HH小写为12小时
     */
    ...
    public static String getNowDay() {
        ...
        Date date = new Date();
        String _time = dateFormat.format(date);
    ...
    public static String getDayBeginDate(long time) {
        Long one = 3 * 24 * 60 * 60 * 1000l;
        Long oneDay = time - one;
        SimpleDateFormat sdf = new SimpleDateFormat(FORMAT1);
        Date oneTime = new Date(oneDay);
        String _time = sdf.format(oneTime);
        return _time;
    }
     ...
     * @return
     */
    public static String getOneMonthBeginDate(long time){
        Long three = 30 * 24 * 60 * 60 * 1000l;
        Long oneMonth = time - three;
        SimpleDateFormat sdf = new SimpleDateFormat(FORMAT1);
        Date oneMonthTime = new Date(oneMonth);
        String _time = sdf.format(oneMonthTime);
        return _time;
    }
